...
namespace App\Services\PlanningService\Documents\V1\Tenant;
 ...
 *
 * @OA\Get(
 *     path="/api/tenant/v1/schedules/calendar",
 *     tags={"Tenant > Schedule"},
 *     summary="calendar",
 *     security={{"bearerAuth":{}}},
 ...
 *
 * @OA\Post(
 *       path="/api/tenant/v1/schedules/{schedule}/reserve",
 *       tags={"Tenant > Schedule"},
