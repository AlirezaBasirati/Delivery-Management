...
namespace App\Services\AuthenticationService\Documents\V1\Driver;
 ...
 *
 * @OA\Post(
 *     path="/api/driver/v1/auth/verify",
 *     tags={"Driver > Authentication"},
 ...
 *
 * @OA\Post(
 *     path="/api/driver/v1/auth/forget",
 *     tags={"Driver > Authentication"},
 ...
 *
 * @OA\Post(
 *     path="/api/driver/v1/auth/set-password",
 *     tags={"Driver > Authentication"},
 ...
 *
 * @OA\Patch(
 *     path="/api/driver/v1/auth/change-password",
 *     tags={"Driver > Authentication"},
 ...
 *
 * @OA\Delete(
 *     path="/api/driver/v1/auth/logout",
 *     tags={"Driver > Authentication"},
