...
class StoreOrderTest extends TestCase
{
    ...
    public function invalidCreateData(): array
    {
        ...
        $customer_required = $data;
        unset($customer_required['customer']);

        $customer_first_name_required = $data;
        unset($customer_first_name_required['customer']['first_name']);

        $customer_last_name_required = $data;
        unset($customer_last_name_required['customer']['last_name']);

        $customer_mobile_required = $data;
        unset($customer_mobile_required['customer']['mobile']);
        ...
        return [
            ...
            'customer.required'            => [$customer_required, 'customer'],
            'customer.first_name.required' => [$customer_first_name_required, 'customer.first_name'],
            'customer.last_name.required'  => [$customer_last_name_required, 'customer.last_name'],
            'customer.mobile.required'     => [$customer_mobile_required, 'customer.mobile'],
        ];
    }
}
